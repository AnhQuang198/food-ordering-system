...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -242974609041704288L;
  ...
  private com.example.system.kafka.order.avro.model.PaymentOrderStatus paymentOrderStatus;
   ...
   */
  public PaymentRequestAvroModel(java.lang.String id, java.lang.String sagaId, java.lang.String customerId, java.lang.String orderId, java.math.BigDecimal price, java.time.Instant createdAt, com.example.system.kafka.order.avro.model.PaymentOrderStatus paymentOrderStatus) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: paymentOrderStatus = (com.example.system.kafka.order.avro.model.PaymentOrderStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.example.system.kafka.order.avro.model.PaymentOrderStatus getPaymentOrderStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentOrderStatus(com.example.system.kafka.order.avro.model.PaymentOrderStatus value) {
   ...
   */
  public static com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder newBuilder() {
    return new com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder();
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder newBuilder(com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder other) {
    if (other == null) {
      return new com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder();
    } else {
      return new com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder newBuilder(com.example.system.kafka.order.avro.model.PaymentRequestAvroModel other) {
    if (other == null) {
      return new com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder();
    } else {
      return new com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.system.kafka.order.avro.model.PaymentRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setCustomerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setPaymentOrderStatus(com.example.system.kafka.order.avro.model.PaymentOrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearPaymentOrderStatus() {
    ...
    public PaymentRequestAvroModel build() {
      try {
        ...
        record.paymentOrderStatus = fieldSetFlags()[6] ? this.paymentOrderStatus : (com.example.system.kafka.order.avro.model.PaymentOrderStatus) defaultValue(fields()[6]);
        return record;
