...
import com.example.order.service.domain.ports.input.message.listener.payment.PaymentResponseMessageListener;
import com.example.system.kafka.consumer.KafkaConsumer;
import com.example.system.kafka.order.avro.model.PaymentResponseAvroModel;
import com.example.system.kafka.order.avro.model.PaymentStatus;
...
public class PaymentResponseKafkaListener implements KafkaConsumer<PaymentResponseAvroModel> {
    ...
    public void receive(@Payload List<PaymentResponseAvroModel> message,
        ...
        log.info("{} number of payment response received with key: {}, partitions: {} and offset: {}",
                message.size(),
                keys.toString(),
                partitions.toString(),
                offsets.toString());
